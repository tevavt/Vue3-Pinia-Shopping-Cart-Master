<template>
    ...
    <table class="table" v-else>
        ...
        <tbody>
            <tr v-for="(cart, index) in carts" :key="index">
                ...
                <td>{{ currencyTHB(cart.product.price) }}</td>
                <td>
    ...
    <button class="btn btn-primary mb-5" @click="cart_store.clear_cart()">Clear Cart</button>
    <button class="btn btn-success mb-5" mx-2 >Total: {{ currencyTHB(cart_store.total) }}</button>
</template>
